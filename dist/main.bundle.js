...
/***/ "../../../../../src/app/Geometry/cube.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Cube;
var THREE = __webpack_require__("../../../../../src/app/lib/THREE.js");
...
/***/ "../../../../../src/app/Geometry/plane.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function Plane(width, height, segments_width, segments_height) {
    if (segments_width === void 0) { segments_width = 1; }
    if (segments_height === void 0) { segments_height = 1; }
    THREE.Geometry.call(this);
    var ix, iy, width_half = width / 2, height_half = height / 2, gridX = segments_width, gridY = segments_height, gridX1 = gridX + 1, gridY1 = gridY + 1, segment_width = width / gridX, segment_height = height / gridY;
...
//# sourceMappingURL=plane.model.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Geometry_plane_model__ = __webpack_require__("../../../../../src/app/Geometry/plane.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Geometry_cube_model__ = __webpack_require__("../../../../../src/app/Geometry/cube.model.ts");
...
var AppComponent = (function () {
    function AppComponent() {
        this.title = 'three.js editor demo';
    ...
    AppComponent.prototype.handleKeyDown = function (event) {
        switch (event.keyCode) {
            case 49:
                ...
                break;
            case 50:
                this.setBrushColor(1);
                break;
            case 51:
                this.setBrushColor(2);
                break;
            case 52:
                this.setBrushColor(3);
                break;
            case 53:
                this.setBrushColor(4);
                break;
            case 54:
                this.setBrushColor(5);
                break;
            case 55:
                this.setBrushColor(6);
                break;
            case 56:
                this.setBrushColor(7);
                break;
            case 57:
                this.setBrushColor(8);
                break;
            case 48:
                this.setBrushColor(9);
                break;
            case 16:
                ...
                break;
            case 37:
                this.offsetScene(-1, 0);
                break;
            case 38:
                this.offsetScene(0, -1);
                break;
            case 39:
                this.offsetScene(1, 0);
                break;
    ...
    AppComponent.prototype.handleMouseDown = function (event) {
    ...
    AppComponent.prototype.handleMouseMove = function (event) {
        event.preventDefault();
        if (this.isMouseDown) {
    ...
    AppComponent.prototype.handleMouseUp = function (event) {
        event.preventDefault();
        this.isMouseDown = false;
    ...
    AppComponent.prototype.handleWheel = function (event) {
    ...
    AppComponent.prototype.init = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_3_jquery__('#scene').append(this.container);
        ...
        this.plane = new THREE.Mesh(new __WEBPACK_IMPORTED_MODULE_1__Geometry_plane_model__["a" /* Plane */](1000, 1000));
        this.plane.rotation.x = -90 * Math.PI / 180;
        this.scene.addObject(this.plane);
        this.cube = new __WEBPACK_IMPORTED_MODULE_2__Geometry_cube_model__["a" /* Cube */](50, 50, 50);
    ...
    AppComponent.prototype.setBrushColor = function (value) {
        this.color = value;
        this.brush.material[0].color.setHex(this.colors[this.color] ^ 0x4C000000);
        this.render();
    };
    AppComponent.prototype.buildFromHash = function () {
        var hash = window.location.hash.substr(1), version = hash.substr(0, 2);
        if (version == "A/") {
    ...
    AppComponent.prototype.updateHash = function () {
        var data = [], current = { x: 0, y: 0, z: 0, c: 0 }, last = { x: 0, y: 0, z: 0, c: 0 }, code;
        ...
        var dataStr = this.encode(data);
        window.location.hash = "A/" + dataStr;
        __WEBPACK_IMPORTED_MODULE_3_jquery__('#link').href = "http://mrdoob.com/projects/voxels/#A/" + dataStr;
    };
    AppComponent.prototype.offsetScene = function (x, z) {
    ...
    AppComponent.prototype.interact = function () {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AppComponent.prototype, "handleMouseDown", null);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* HostListener */])('mousemove', ['$event']),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AppComponent.prototype, "handleMouseMove", null);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* HostListener */])('mouseup', ['$event']),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AppComponent.prototype, "handleMouseUp", null);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* HostListener */])('wheel', ['$event']),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AppComponent.prototype, "handleWheel", null);
